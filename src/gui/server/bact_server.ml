       ...
       ["purpose", `String "list_acids";
        "data", `List [
                   `Assoc ["type", `String "places";
                           "acids", `List (List.map Proteine.acid_to_yojson AcidExamples.nodes)];
                   `Assoc ["type", `String "inputs_arcs";
                           "acids", `List (List.map Proteine.acid_to_yojson AcidExamples.input_arcs)];
                   `Assoc ["type", `String "outputs_arcs";
                           "acids", `List (List.map Proteine.acid_to_yojson AcidExamples.output_arcs)];
                   `Assoc ["type", `String "extensions";
                           "acids", `List (List.map Proteine.acid_to_yojson AcidExamples.extensions);]]] in
