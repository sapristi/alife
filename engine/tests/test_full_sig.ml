...
let test_ser_deser_equality name get_bact nb_reacs () =
  ...
  Alcotest.check reac_mgr_c_testable ("ser_deser reac_mgr c " ^ name)  bact.reac_mgr.c_set serdeser.reac_mgr.c_set;

  Alcotest.check reac_mgr_testable ("ser_deser reac_mgr " ^ name)  bact.reac_mgr serdeser.reac_mgr;
