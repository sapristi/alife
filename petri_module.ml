...
struct
  ...
  object
    ...
    method check_init =
      ...
      (* vérifie que les places sont bien rangées selon leur id *)
	...
	!res
      ...
      (* vérifie que les noeuds sont bien rangées selon leur id *)
      and check_nodes = 
	let res = ref false in
	for i = 0 to places_number do
	...
	!res
      ...
      (* vérifie que la transition t est bien entre les noeuds et les places déclarées *)
